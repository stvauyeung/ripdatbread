var app = angular.module('breadDirectives', ['ngCookies']);
...
app.directive('successBtn', ['$rootScope', '$timeout', function($rootScope, $timeout) {
  return {
    restrict: 'A',
...
app.directive('ripBtn', ['$rootScope', '$timeout', function($rootScope, $timeout) {
  return {
    restrict: 'A',
...
app.directive('dipBtn', ['$rootScope', '$timeout', function($rootScope, $timeout) {
  return {
    restrict: 'A',
    link: function(scope, elm, attr) {
...
app.directive('lastSlice', ['$window', function($window) {
  return {
    restrict: 'A',
    link: function(scope, elm, attrs) {
...
app.directive('requireLogin', ['$cookies', '$rootScope', '$sce', function($cookies, $rootScope, $sce) {
  return {
    restrict: 'A',
    link: function(scope, elm, attr) {
      $rootScope.alerts = [];
